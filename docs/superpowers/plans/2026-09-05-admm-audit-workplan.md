...
- Withdrawn by the September 20 user decision: external MCP inspection. Representative native DMM/TGM round-trip and operation checks remain required.
